...
declare -a stig_services_disable_list=(
  ...
  "dnsmasq" "dovecot" "ftp" "isc-dhcp-server" "ldap-utils"
...
declare -A stig_sysctl_config_hash=(
# configure ICMP
...
declare -A stig_sshd_config_hash=(
  [PermitRootLogin]="no"
  [Protocol]=2
...
declare -A stig_lightdm_config_hash=(
  [allow-guest]="false"
